...
function PersonalDataStep({ cpfMask, phoneNumberMask, submitButtonLabel, onSubmit, form, loading, }) {
    return (react_1.default.createElement("form", { style: { margin: "auto" }, onSubmit: (event) => {
        ...
        react_1.default.createElement(Grid_1.default, { container: true, spacing: 1 },
            ...
            react_1.default.createElement(Grid_1.default, { item: true, xs: 12, md: 5 },
                react_1.default.createElement(react_input_mask_1.default, { mask: phoneNumberMask, value: form.phoneNumber.value, disabled: loading, onFocus: form.phoneNumber.onFocus, onBlur: form.phoneNumber.onBlur, onChange: (event) => form.phoneNumber.onChange(event.target.value) }, () => (react_1.default.createElement(TextField_1.default, { fullWidth: true, label: form.phoneNumber.label, variant: "outlined", error: form.phoneNumber.error, helperText: form.phoneNumber.helperText })))),
            react_1.default.createElement(Grid_1.default, { item: true, xs: 12 },
